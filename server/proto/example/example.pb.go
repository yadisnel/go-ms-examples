...
var _Example_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/yadisnel/go-ms-examples/server/proto/example/example.proto",
}

func init() {
	proto.RegisterFile("github.com/yadisnel/go-ms-examples/server/proto/example/example.proto", fileDescriptor0)
}
