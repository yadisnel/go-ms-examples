...
// source: github.com/yadisnel/go-ms/v2examples/server/proto/example/example.proto

/*
Package go_micro_srv_example is a generated protocol buffer package.

It is generated from these files:
	github.com/yadisnel/go-ms/v2examples/server/proto/example/example.proto
...
var _Example_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/yadisnel/go-ms/v2examples/server/proto/example/example.proto",
}

func init() {
	proto.RegisterFile("github.com/yadisnel/go-ms/v2examples/server/proto/example/example.proto", fileDescriptor0)
}
